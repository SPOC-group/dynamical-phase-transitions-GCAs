...
from src.backtracking_dynamic_cavity.rules import TotalisiticRule, DEAD, ALIFE, X_POS, Y_POS
from src.backtracking_dynamic_cavity.initialization import init_random_Gauss
from src.backtracking_dynamic_cavity.observables import Observables
from src.backtracking_dynamic_cavity.utils import sample_from_cdf
...
from src.backtracking_dynamic_cavity.population_dynamics import step as pop_step
def population_dynamics(chi_comp,its, rule_code, c=1, p=0,
                   init_func=init_random_Gauss, alpha=0.99,m_parisi = 0.0,
                   m_target=None, population_n=600, attraction_factor=2, fix_observable=None, balance_colors=False,
                   log_dir=None, log_suffix='', all_rattlers=None, homogenous_point_attractor=None, require_full_rattling=False, epsilon=None, target_observable=None, target_value=None,**kwargs):
    """
